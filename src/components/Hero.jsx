...
const Hero = () => {
    return (
        <div className='flex mx-auto justify-center items-center my-[60px]'>
            <div className="hero-content flex flex-col items-start gap-5">
                ...
                <p className="hero-heading text-5xl">Supercharge Your <br></br><p className='gradient-text'>Digital Workflow</p></p>
...
software—all in one place. Start creating faster today.</p>
            ...
            <img className='max-w-md' src={banner} alt="banner right image" />
        </div>
    );
};
